...
public class JFrameStory2 extends javax.swing.JFrame {
    ...
    public JFrameStory2() {
        ...
        q.enqueue("You killed the Mantis Lord, and move forward. Suddenly, a weapon throws towards you.");
        q.enqueue("You dodged it, and saw a big Hornet with a chain rope, standing there with guilt, as he saw his fallen brother - Mantis Lord, had died.");
        q.enqueue("The Hornet swear for his revenge, and you are prepare to battle!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameStory2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
