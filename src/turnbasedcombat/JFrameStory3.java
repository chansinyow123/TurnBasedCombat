...
public class JFrameStory3 extends javax.swing.JFrame {
    ...
    public JFrameStory3() {
        ...
        q.enqueue("After a long fight, you finally defeated Hornet. You move forward, and see an unexcepted enemy - The Dark Lord, which is still alive.");
        q.enqueue("You recall back your memories, and realize the person you kill in the past, is just a clone of him.");
        q.enqueue("The Dark Lord sitting on a chair, laughing at your foolish. You feel utterly rage, and charge your swords towards him");
        q.enqueue("The Dark Lord stands up, and prepare to fight you.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameStory3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
