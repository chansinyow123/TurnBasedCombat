...
public class JFrameRound2 extends javax.swing.JFrame {
    ...
    public JFrameRound2() {
        ...
        player = new Player(1000, 1000, 100, 120, 40, 40);
        enemy = new Enemy(2000, 2000, 150, 180, "Hornet");
        ...
        jLabelPlayerDialog.setText("> Here we go again...");
        jLabelEnemyDialog.setText("> The " + enemy.getName() + " is ready for his skills!");

        dialogList.add(new Dialog("Here we go again...", "Player"));
        dialogList.add(new Dialog("The " + enemy.getName() + " is ready for his skills!", enemy.getName()));
    ...
    private void initComponents() {
        ...
        jLabelEnemyAtk.setText("150 - 180");
        ...
        jLabelPlayerCurrentHP.setText("1000");
        ...
        jButtonHeal.setText("Heal   (-20 MP, + 650 HP)");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabelTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 302, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(33, 33, 33)
    ...
    private void jButtonContinueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonContinueActionPerformed
        ...
        if (player.getCurrentHP() <= 0) {
            ...
            game.setRoundTwo(round);

            Game.saveToFile(game);

            new JFrameStory3().setVisible(true);
            this.dispose();
        }
    ...
    private void playerWon() {
        ...
        dialogList.add(new Dialog(enemy.getName() + " has been SMASHED!", "System"));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameRound2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameRound2().setVisible(true);
            }
        });
    }
