...
public class JFrameRound1 extends javax.swing.JFrame {
    ...
    public JFrameRound1() {
        ...
        player = new Player(500, 500, 80, 100, 30, 30);
        enemy = new Enemy(1000, 1000, 80, 100, "Mantis Lord");
        ...
        jLabelPlayerDialog.setText("> You're ready to smash it's face.");
        jLabelEnemyDialog.setText("> " + enemy.getName() + " think you were weak!");

        dialogList.add(new Dialog("You're ready to smash it's face.", "Player"));
        dialogList.add(new Dialog(enemy.getName() + " think you were weak!", enemy.getName()));
    ...
    private void initComponents() {
        ...
        jLabelPlayerCurrentHP.setText("600");
        ...
        jButtonHeal.setText("Heal   (-20 MP, + 400 HP)");
        ...
        jButtonRest.setText("Rest   (+10 MP)");
        ...
        jLabelTitle.setText("Player VS (Enemy)");
        ...
        jLabelPlayerCurrentMP.setText("20");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(jButtonRest, javax.swing.GroupLayout.DEFAULT_SIZE, 352, Short.MAX_VALUE)
                                    .addComponent(jButtonAttack, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jButtonHeal, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addGap(18, 18, 18)
                                .addComponent(jButtonContinue, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jButtonRest, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE))
    ...
    private void jButtonRestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRestActionPerformed
        ...
        sound.get("Rest").play();
        int increaseMP = 10;
        player.calculateMP(increaseMP);

        jLabelPlayerCurrentMP.setText(player.getCurrentMP() + "");
        jLabelPlayerDialog.setText("> You have RESTED for " + increaseMP + " MP!");
        dialogList.add(new Dialog("You have RESTED for " + increaseMP + " MP!", "Player"));
        enemyAttack();
        round++;
    ...
    private void jButtonHealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHealActionPerformed
        ...
        if (player.getCurrentMP() < reduceMP) {
            ...
            jLabelPlayerCurrentHP.setText(player.getCurrentHP() + "");
            jLabelPlayerCurrentMP.setText(player.getCurrentMP() + "");
            jLabelPlayerDialog.setText("> You have HEALED for " + increaseHP + " HP with " + reduceMP + " MP!");
            
            dialogList.add(new Dialog("You have HEALED for " + increaseHP + " HP with " + reduceMP + " MP!", "Player"));
    ...
    private void jButtonContinueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonContinueActionPerformed
        ...
        if (player.getCurrentHP() <= 0) {
            ...
            game.setRoundOne(round);

            Game.saveToFile(game);

            new JFrameStory2().setVisible(true);
            this.dispose();
        }
    ...
    private void playerWon(int playerDmg) {
    ...
    private void enemyAttack() {
        int enemyDmg = enemy.getAttackDmg();
        double percentage;
        int playerHealthBar;
        ...
        if (player.getCurrentHP() <= 0) {
            ...
            jLabelEnemyDialog.setText("> " + enemy.getName() + " has HIT you with " + enemyDmg + " damage!");
            
            dialogList.add(new Dialog(enemy.getName() + " has HIT you with " + enemyDmg + " damage!", enemy.getName()));
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameRound1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
